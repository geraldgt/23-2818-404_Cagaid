    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                <label for="number_3">c:</label>
                <input type="text" id="number_3" name="number_3" required>
            </div>
            
            <div class="form-group">
                <label for="number_4">d:</label>
                <input type="text" id="number_4" name="number_4" required>
            </div>
